...
void blitCardImageToScreen(int sx, int sy, int width, int height, Image* source, int dx, int dy)
{
	if (!initialized) return;
...
void blitAlphaImageToScreenScaled(int sx, int sy, int width, int height, Image* source, int dx, int dy, int endx, int endy)
{
	if (!initialized) return;
